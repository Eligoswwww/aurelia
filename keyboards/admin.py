...
USER_TEST_PANEL = InlineKeyboardMarkup(
    inline_keyboard=[
...
# Отдельная кнопка для вывода обеих панелей в админском меню
...
# Обработчики кнопок пользователя (тестовые)
...
def register_handlers(dp):
    # Основные кнопки для админского меню
